...
export const selectStyle = { background: "#fff", border: `1px solid ${COLORS.line}`, padding: "12px 12px", minHeight: 44, fontSize: 14, fontFamily: "'IBM Plex Sans', sans-serif", color: COLORS.dark };
export const inputStyle = { width: "100%", border: `1px solid ${COLORS.line}`, padding: "12px 12px", minHeight: 44, fontSize: 16, fontFamily: "'IBM Plex Sans', sans-serif", color: COLORS.dark, background: "#fff", boxSizing: "border-box" };
export const primaryButtonStyle = { background: COLORS.safety, color: COLORS.dark, border: "none", padding: "13px 18px", minHeight: 46, fontFamily: "'Oswald', sans-serif", textTransform: "uppercase", fontWeight: 600, fontSize: 14, display: "flex", alignItems: "center", justifyContent: "center", gap: 8, cursor: "pointer" };
export const ghostButtonStyle = { background: "none", border: `1px solid ${COLORS.line}`, padding: "12px 16px", minHeight: 46, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 };
...
// Sistema de aviso visual (toast). Envuelve la app con <ToastProvider> una
// vez y desde cualquier módulo hijo se llama a useToast().show("Guardado").
        ...
        {toasts.map((t) => (
          <div
            ...
            style={{
              ...
              alignItems: "center",
              gap: 8,
              background: t.type === "error" ? COLORS.critical : COLORS.dark,
              color: "#fff",
              padding: "12px 16px",
              maxWidth: 420,
              width: "100%",
          ...
          >
            {t.type === "error" ? <XCircle size={18} /> : <CheckCircle2 size={18} color={COLORS.safety} />}
            <span>{t.message}</span>
          </div>
        ))}
      </div>
...
// Devuelve una función show(message, type) con type "success" (por defecto) o "error".
